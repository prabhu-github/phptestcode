...
class Braintree_lib 
{
	...
	function __construct()
	{
		...
		Braintree_Configuration::merchantId('yqxq87b5nk9gwxk9');
		Braintree_Configuration::publicKey('bvjq9cdpnxbm26kx');
		Braintree_Configuration::privateKey('f739c8aa716472fd0e1974940fa9e383');	
	}
